...
//      start and end date for API
        ...
        String apiKey = "1cd9373b6fc64b9dab6a872f42134d5f";
//      API URL
...
//        API url
        ...
        String URL = "https://api.apilayer.com/exchangerates_data/latest?symbols="+symbols+"&base="+base+"&apikey=1cd9373b6fc64b9dab6a872f42134d5f";
